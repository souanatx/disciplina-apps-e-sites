...
<td><input name="nome" size="45" type="text" value="
<?php 
if ($_POST)
	if(!empty($_POST["nome"]))
		echo $_POST["nome"];
...
<td><input name="idade" type="text" value="
<?php 
if ($_POST)
...
</select>&nbsp;<input name="nr_documento" type="text" value="
<?php 
if ($_POST)
...
</fieldset><fieldset><legend>Experi&ecirc;ncia profissional:</legend> <label>Situa&ccedil;&atilde;o profissional: <input checked="checked" name="experiencia" type="radio" value="Sem experiência" 
<?php 
if ($_POST)
	if($_POST["experiencia"]=="Sem experiência")
		echo "checked";
?>" /> Sem experi&ecirc;ncia <input name="experiencia" type="radio" value="Inferior a 5 anos" 
<?php 
if ($_POST)
